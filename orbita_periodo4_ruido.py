...
def ecuaciones(v, dv,eps1):
    ...
    y=v[1]
    z=v[2]
    eps1, A, eps2,omega = 0.2,11.5,1,3.6
...
for m in range(11):
    ...
    cont=0
    while t<t_max:
        eps1 = 0.2*(1+0.25*random.normalvariate(0,0.25))
    ...
    x = x[:60000]
    np.savetxt('/Users/juliamindlin/Dropbox/Cursos_Materias/DNL/ENSO/Paper/Codigos/periodo4_masruido/nino_periodo4_con_ruido_'+str(m)+'.txt', x)
