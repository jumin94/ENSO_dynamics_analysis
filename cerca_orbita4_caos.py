...
def ecuaciones(v, dv,eps1):
    ...
    y=v[1]
    z=v[2]
    A, eps2,omega = 11.5,1,4.3 #Cerca de la lengua de arnold de periodo 4, pero donde hay caos
...
for m in range(11):
    ...
    x = x[:60000]
    np.savetxt('/Users/juliamindlin/Dropbox/Cursos_Materias/DNL/ENSO/Paper/Codigos/cerca_periodo4_caos/nino_caos_cerca_de_periodo4_'+str(m)+'.txt', x)
